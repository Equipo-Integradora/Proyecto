...
<?php
    ...
    if(isset($_SESSION["usuario"])) {
        extract($_POST);
            ...
            $citas = "SELECT *
                      FROM mis_ordenes
                      WHERE id_usuario= '{$_SESSION["id"]}' and estado_orden_venta='Caducado'  AND (productos  like '%$busca%' or id_venta like '%$busca%') 
        ...
        ?>
         ...
         <div class="container" style="margin-top: 20px;">
                ...
                <?php	
                        ...
                        <div class="col-12" style="background-color: white; width:800px; height:60px">
                                <div class="col-5 " style="margin-top: 9px; ">
                                    <form action="../scripts/buscar_orpa.php" method="post">
                                        <input style="width: 290px; margin-top:8px" placeholder="No. de orden o  Artículo..." type="search" class="input" name="buscar">
                                    </form>
                                </div>
                            </div>
                        <div class="row">
                    ...
                    <div class="col-12" style="background-color: white; width:800px; height:60px">
                    <div class="col-5 " style="margin-top: 9px; ">
                <form action="../scripts/buscar_orcad.php" method="post">
