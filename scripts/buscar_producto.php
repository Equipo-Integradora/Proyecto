...
<body>
    <div class="container">
        <h1 align="center">Coincidencias</h1>
        <form action="../scripts/verfiltradocliente.php" method='post' style="width:auto margin=auto" >
        ...
        <?php
            ...
            extract($_POST);
            $consultapro ="SELECT productos.nombre_producto, productos.precio_producto, tipo_categorias.nombre_tipo_categoria, detalle_productos.existencias_detalle_producto, detalle_productos.imagen_detalle_producto
            ...
            $tabla = $conexion->seleccionar($consultapro);
