            ...
            <div class="container">
                ...
                foreach ($cat as $index => $ca) { ?>
                   ...
                   <?php foreach ($cat_ti as $c) { ?>
                      <li class="list-group-item"><?php echo "<a class='tcategoria'href='../scripts/verproductos_cat.php'>".$c->nombre_tipo_categoria."</a>"?></li>
                   <?php } ?>                   
                        </ul>
                    </div>
                    <?php
...
foreach ($tabla as $reg) { ?>
    ...
    <a style="margin: auto;" href="../views/verproducto.php?id=<?php echo $reg->id_detalle_producto ?> "><img class="card-img-top pro" src="../img/productos/<?php echo $reg->imagen_detalle_producto; ?>" 
